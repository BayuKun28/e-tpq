                            ...
                            <tbody>
                                ...
                                <?php foreach ($santri as $s) : ?>
                                    <tr>
                                        ...
                                        <td><?= $s['jk']; ?></td>
                                        <td>
                                            <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modaleditsantri" data-idedit="<?= $s['id']; ?>" data-namaedit="<?= $s['nama']; ?>" data-tanggal_lahiredit="<?= $s['tanggal_lahir']; ?>" data-alamatedit="<?= $s['alamat']; ?>" data-jkedit="<?= $s['jk']; ?>" data-id_waliedit="<?= $s['id_wali']; ?>" data-namawaliedit="<?= $s['namawali']; ?>" data-is_activeedit="<?= $s['is_active']; ?>" name="editsantri" id="editsantri"><i class="fa fa-edit"></i></a>
                                            <a data-kode="<?= $s['id']; ?>" href='javascript:void(0)' class="del_santri btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach ?>
